          ...
          Expanded(
            child: Column(
              children: [
                ...
                FittedBox(
                  child: Text(
                    item.actualBundle == -1 ? "" : item.actualBundle.toString(),
                    style: TextStyle(
                      fontSize: 40,
                      fontWeight: FontWeight.bold,
                      color: Colors.blue[800],
          ...
          Expanded(
            child: Column(
              children: [
                ...
                FittedBox(
                  child: Text(
                    item.actualRetail == -1 ? "" : item.actualRetail.toString(),
                    style: TextStyle(
                      fontSize: 40,
                      fontWeight: FontWeight.bold,
                      color: Colors.blue[800],
    ...
    children: [
          ...
          RichText(
            text: TextSpan(
              ...
              children: [
                TextSpan(text: 'Case : '),
                TextSpan(
                  text: item.actualBundle.toString(),
                  style: TextStyle(
                    color: Colors.green,
                    fontWeight: FontWeight.bold,
                  ),
      ...
      RichText(
        text: TextSpan(
          ...
          children: [
            ...
            TextSpan(
              text: item.actualRetail.toString(),
              style: TextStyle(
                color: Colors.green,
      ...
      RichText(
        text: TextSpan(
          ...
          children: [
            ...
            TextSpan(
              text: item.totalActualRetailUnits.toString(),
              style: TextStyle(
                color: Colors.purple,
      ...
      Row(
        children: [
          ...
          Text(
            (item.totalPriceActual).toString(),
