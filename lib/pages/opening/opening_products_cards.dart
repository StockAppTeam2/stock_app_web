          ...
          Expanded(
            child: Column(
              children: [
                ...
                FittedBox(
                  child: Text(
                    item.openingBundle == -1
                        ? ""
                        : item.openingBundle.toString(),
                    style: TextStyle(
                      fontSize: 40,
                      fontWeight: FontWeight.bold,
                      color: Colors.blue[800],
          ...
          Expanded(
            child: Column(
              children: [
                ...
                FittedBox(
                  child: Text(
                    item.openingRetail == -1
                        ? ""
                        : item.openingRetail.toString(),
                    style: TextStyle(
                      fontSize: 40,
                      fontWeight: FontWeight.bold,
                      color: Colors.blue[800],
          ...
          RichText(
            text: TextSpan(
              ...
              children: [
                TextSpan(text: 'Case : '),
                TextSpan(
                  text: item.openingBundle.toString(),
                  style: TextStyle(
                    color: Colors.green,
                    fontWeight: FontWeight.bold,
                  ),
      ...
      RichText(
        text: TextSpan(
          ...
          children: [
            ...
            TextSpan(
              text: item.openingRetail.toString(),
              style: TextStyle(
                color: Colors.green,
      ...
      RichText(
        text: TextSpan(
          ...
          children: [
            ...
            TextSpan(
              text: item.totalOpenRetailUnits.toString(),
              style: TextStyle(
                color: Colors.purple,
